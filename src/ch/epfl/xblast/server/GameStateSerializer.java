 ...
 * GameStateSerializer
 *
 * Serializes (and compresses via {@link RunLengthEncoder}) a {@link GameState}.
...
public final class GameStateSerializer {
    ...
    /**
     * @return a byte list containing the serialized version of the specified GameState.
     * @param bp {@link BoardPainter} to be used.
     * @param gs {@link GameState} to be serialized.
     */
